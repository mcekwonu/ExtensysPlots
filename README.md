 ...
 * M.T. Nasir, M.C. Ekwonu, J.A. Esfahani, K.C. Kim, (2021): ["Performance assessment and multi-objective optimization of an Organic Rankine Cycles and Vapor Compression Cycle Based Combined Cooling, Heating, and Power System"](http://), [(open access)](http://). Sustainable Energy Technologies and Assessments.
